...
files <- c("time_series_19-covid-Confirmed.csv", "time_series_19-covid-Deaths.csv", "time_series_19-covid-Recovered.csv")
```
...
df_cases_extra <-
  ...
  mutate(daysSinceOutbreak = as.numeric(date - firstOutbreak)/86400,
  ...
  select(-c(firstOutbreak, first200Outbreak))
