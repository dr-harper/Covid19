...
# fix bug in set colour https://github.com/Mikata-Project/ggthemr/issues/44
swatch_pal <- function() {
  function(n) {
...
Have any graphs you would like to see made in this website? [Reach out to me](about) with suggestions and I would love to add them!
