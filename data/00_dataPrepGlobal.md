...
```
    ...
    ##  [8] packrat_0.5.0      R6_2.4.1           cellranger_1.1.0   backports_1.1.7    reprex_0.3.0       evaluate_0.14      e1071_1.7-3       
    ## [15] httr_1.4.1         pillar_1.4.4       rlang_0.4.6        curl_4.3           readxl_1.3.1       rstudioapi_0.11    raster_3.1-5      
    ## [22] munsell_0.5.0      broom_0.5.6        compiler_4.0.0     modelr_0.1.7       xfun_0.14          pkgconfig_2.0.3    htmltools_0.4.0   
    ## [29] tidyselect_1.0.0   codetools_0.2-16   fansi_0.4.1        crayon_1.3.4       dbplyr_1.4.3       withr_2.2.0        grid_4.0.0        
    ## [36] nlme_3.1-147       spData_0.3.5       jsonlite_1.6.1     gtable_0.3.0       lifecycle_0.2.0    DBI_1.1.0          magrittr_1.5      
    ## [43] units_0.6-6        scales_1.1.1       KernSmooth_2.23-16 cli_2.0.2          stringi_1.4.6      fs_1.4.1           sp_1.4-1          
    ## [50] xml2_1.3.2         ellipsis_0.3.1     generics_0.0.2     vctrs_0.3.0        tools_4.0.0        glue_1.4.1         hms_0.5.3         
