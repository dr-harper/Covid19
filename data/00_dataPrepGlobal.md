...
```
    ...
    ##  [1] rmarkdown_2.1        shinydashboard_0.7.1 shiny_1.3.2          emojifont_0.5.3      plotly_4.9.2         magick_2.3           ggthemr_1.1.0       
    ##  [8] patchwork_0.0.1.9000 gganimate_1.0.5      maps_3.3.0           sf_0.8-0             forcats_0.4.0        stringr_1.4.0        dplyr_0.8.5         
    ## [15] purrr_0.3.3          tidyr_1.0.2          tibble_2.1.3         ggplot2_3.3.0.9000   tidyverse_1.2.1      readr_1.3.1          here_0.1            
    ## 
    ## loaded via a namespace (and not attached):
    ##  [1] nlme_3.1-140          matrixStats_0.54.0    lubridate_1.7.4       progress_1.2.2        httr_1.4.1            rstan_2.18.2         
    ##  [7] rprojroot_1.3-2       tools_3.6.0           backports_1.1.5       R6_2.4.1              KernSmooth_2.23-15    spData_0.3.2         
    ## [13] DBI_1.1.0             lazyeval_0.2.2        colorspace_1.4-1      withr_2.1.2           processx_3.4.2        tidyselect_1.0.0     
    ## [19] gridExtra_2.3         prettyunits_1.1.1     curl_4.3              compiler_3.6.0        cli_2.0.2             rvest_0.3.5          
    ## [25] xml2_1.2.5            labeling_0.3          bookdown_0.18         scales_1.1.0          classInt_0.4-2        callr_3.4.3          
    ## [31] StanHeaders_2.18.1-10 digest_0.6.25         pkgconfig_2.0.3       htmltools_0.4.0       showtext_0.7-1        htmlwidgets_1.5.1    
    ## [37] rlang_0.4.5           readxl_1.3.1          rstudioapi_0.11       sysfonts_0.8          farver_2.0.3          generics_0.0.2       
    ## [43] jsonlite_1.6.1        inline_0.3.15         magrittr_1.5          loo_2.1.0             Rcpp_1.0.4            munsell_0.5.0        
    ## [49] fansi_0.4.1           proto_1.0.0           viridis_0.5.1         lifecycle_0.2.0       stringi_1.4.6         yaml_2.2.1           
    ## [55] pkgbuild_1.0.6        parallel_3.6.0        promises_1.1.0        crayon_1.3.4          lattice_0.20-38       haven_2.1.0          
    ## [61] hms_0.4.2             ps_1.3.2              knitr_1.28            pillar_1.4.3          stats4_3.6.0          glue_1.3.2           
    ## [67] packrat_0.5.0         evaluate_0.14         data.table_1.12.2     gifski_0.8.6          modelr_0.1.4          vctrs_0.2.4          
    ## [73] tweenr_1.0.1          httpuv_1.5.1          cellranger_1.1.0      gtable_0.3.0          assertthat_0.2.1      xfun_0.12            
    ## [79] mime_0.9              xtable_1.8-4          broom_0.5.2           e1071_1.7-3           later_1.0.0           rsconnect_0.8.13     
    ## [85] class_7.3-15          viridisLite_0.3.0     showtextdb_2.0        units_0.6-5           ellipsis_0.3.0        spDataLarge_0.3.1
