...
```
    ...
    ##  [1] maps_3.3.0      sf_0.9-5        rmarkdown_2.3   here_0.1        forcats_0.5.0   stringr_1.4.0   dplyr_1.0.0     purrr_0.3.4     readr_1.3.1    
    ...
    ##  [8] R6_2.4.1           cellranger_1.1.0   backports_1.1.8    reprex_0.3.0       evaluate_0.14      e1071_1.7-3        httr_1.4.1        
    ## [15] pillar_1.4.6       rlang_0.4.7        curl_4.3           readxl_1.3.1       rstudioapi_0.11    raster_3.3-7       blob_1.2.1        
    ## [22] munsell_0.5.0      broom_0.7.0        compiler_4.0.2     modelr_0.1.8       xfun_0.15          pkgconfig_2.0.3    htmltools_0.5.0   
    ## [29] tidyselect_1.1.0   bookdown_0.20      codetools_0.2-16   fansi_0.4.1        crayon_1.3.4       dbplyr_1.4.4       withr_2.2.0       
    ## [36] grid_4.0.2         spData_0.3.8       jsonlite_1.7.0     gtable_0.3.0       lifecycle_0.2.0    DBI_1.1.0          magrittr_1.5      
    ## [43] units_0.6-7        scales_1.1.1       KernSmooth_2.23-17 cli_2.0.2          stringi_1.4.6      fs_1.4.2           sp_1.4-2          
    ## [50] xml2_1.3.2         ellipsis_0.3.1     generics_0.0.2     vctrs_0.3.2        tools_4.0.2        glue_1.4.1         hms_0.5.3         
    ## [57] yaml_2.2.1         colorspace_1.4-1   classInt_0.4-3     rvest_0.3.5        knitr_1.29         haven_2.3.1
