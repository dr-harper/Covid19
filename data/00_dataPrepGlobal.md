...
```
    ...
    ##  [1] shinydashboard_0.7.1 shiny_1.3.2          emojifont_0.5.3      plotly_4.9.2         magick_2.3           ggthemr_1.1.0       
    ##  [7] patchwork_0.0.1.9000 gganimate_1.0.5      maps_3.3.0           glue_1.3.2           metathis_1.0.2       sf_0.8-0            
    ## [13] rmarkdown_2.1        here_0.1             forcats_0.4.0        stringr_1.4.0        dplyr_0.8.5          purrr_0.3.3         
    ## [19] readr_1.3.1          tidyr_1.0.2          tibble_2.1.3         ggplot2_3.3.0.9000   tidyverse_1.2.1     
    ## 
    ...
    ## [15] gridExtra_2.3      tidyselect_1.0.0   prettyunits_1.1.1  curl_4.3           compiler_3.6.0     cli_2.0.2          rvest_0.3.5       
    ## [22] Cairo_1.5-10       xml2_1.2.5         labeling_0.3       bookdown_0.18      scales_1.1.0       classInt_0.4-2     digest_0.6.25     
    ## [29] pkgconfig_2.0.3    htmltools_0.4.0    showtext_0.7-1     highr_0.8          htmlwidgets_1.5.1  rlang_0.4.5        readxl_1.3.1      
    ## [36] rstudioapi_0.11    sysfonts_0.8       farver_2.0.3       generics_0.0.2     jsonlite_1.6.1     crosstalk_1.1.0.1  magrittr_1.5      
    ## [43] Rcpp_1.0.4         munsell_0.5.0      fansi_0.4.1        viridis_0.5.1      proto_1.0.0        lifecycle_0.2.0    stringi_1.4.6     
    ## [50] yaml_2.2.1         promises_1.1.0     crayon_1.3.4       lattice_0.20-38    haven_2.1.0        hms_0.4.2          knitr_1.28        
    ## [57] pillar_1.4.3       packrat_0.5.0      evaluate_0.14      data.table_1.12.2  gifski_0.8.6       modelr_0.1.4       vctrs_0.2.4       
    ## [64] tweenr_1.0.1       httpuv_1.5.1       cellranger_1.1.0   gtable_0.3.0       assertthat_0.2.1   xfun_0.12          mime_0.9          
    ## [71] xtable_1.8-4       broom_0.5.2        e1071_1.7-3        later_1.0.0        class_7.3-15       viridisLite_0.3.0  showtextdb_2.0    
    ## [78] units_0.6-5        ellipsis_0.3.0     spDataLarge_0.3.1
