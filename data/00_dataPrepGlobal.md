...
```
    ...
    ## [22] labeling_0.3       bookdown_0.18      scales_1.1.0       classInt_0.4-2     digest_0.6.25      pkgconfig_2.0.3    htmltools_0.4.0   
    ## [29] showtext_0.7-1     highr_0.8          htmlwidgets_1.5.1  rlang_0.4.5        readxl_1.3.1       rstudioapi_0.11    sysfonts_0.8      
    ## [36] farver_2.0.3       generics_0.0.2     jsonlite_1.6.1     magrittr_1.5       Rcpp_1.0.4         munsell_0.5.0      fansi_0.4.1       
    ## [43] proto_1.0.0        lifecycle_0.2.0    stringi_1.4.6      yaml_2.2.1         promises_1.1.0     crayon_1.3.4       lattice_0.20-38   
    ## [50] haven_2.1.0        hms_0.4.2          knitr_1.28         pillar_1.4.3       packrat_0.5.0      evaluate_0.14      data.table_1.12.2 
    ## [57] gifski_0.8.6       modelr_0.1.4       vctrs_0.2.4        tweenr_1.0.1       httpuv_1.5.1       cellranger_1.1.0   gtable_0.3.0      
    ## [64] assertthat_0.2.1   xfun_0.12          mime_0.9           xtable_1.8-4       broom_0.5.2        e1071_1.7-3        later_1.0.0       
    ## [71] class_7.3-15       viridisLite_0.3.0  showtextdb_2.0     units_0.6-5        ellipsis_0.3.0     spDataLarge_0.3.1
