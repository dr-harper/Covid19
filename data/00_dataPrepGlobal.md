...
```
    ...
    ##  [7] patchwork_1.0.0      gganimate_1.0.5      maps_3.3.0           sf_0.9-2             rmarkdown_2.1        here_0.1            
    ## [13] forcats_0.5.0        stringr_1.4.0        dplyr_0.8.5          purrr_0.3.4          readr_1.3.1          tidyr_1.0.2         
    ## [19] tibble_3.0.1         ggplot2_3.3.0        tidyverse_1.3.0     
    ## 
    ...
    ## [15] raster_3.1-5       withr_2.2.0        sp_1.4-1           tidyselect_1.0.0   prettyunits_1.1.1  curl_4.3           compiler_4.0.0    
    ## [22] cli_2.0.2          rvest_0.3.5        xml2_1.3.2         bookdown_0.18      scales_1.1.0       classInt_0.4-3     digest_0.6.25     
    ## [29] pkgconfig_2.0.3    htmltools_0.4.0    showtext_0.7-1     fastmap_1.0.1      dbplyr_1.4.3       htmlwidgets_1.5.1  rlang_0.4.5       
    ## [36] readxl_1.3.1       rstudioapi_0.11    sysfonts_0.8       farver_2.0.3       generics_0.0.2     jsonlite_1.6.1     magrittr_1.5      
    ## [43] Rcpp_1.0.4.6       munsell_0.5.0      fansi_0.4.1        proto_1.0.0        lifecycle_0.2.0    stringi_1.4.6      yaml_2.2.1        
    ## [50] promises_1.1.0     crayon_1.3.4       lattice_0.20-41    haven_2.2.0        hms_0.5.3          knitr_1.28         pillar_1.4.3      
    ## [57] codetools_0.2-16   reprex_0.3.0       glue_1.4.0         evaluate_0.14      data.table_1.12.8  modelr_0.1.7       httpuv_1.5.2      
    ## [64] vctrs_0.2.4        tweenr_1.0.1       cellranger_1.1.0   gtable_0.3.0       assertthat_0.2.1   xfun_0.13          mime_0.9          
    ## [71] xtable_1.8-4       broom_0.5.6        e1071_1.7-3        later_1.0.0        class_7.3-17       viridisLite_0.3.0  showtextdb_2.0    
    ## [78] units_0.6-6        ellipsis_0.3.0
